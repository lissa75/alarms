...
const {text, time}  = alarm
  ...
  <h1 className="text-3xl font-bold dark:text-white text-gray-800 mb-4">Будильник #{id}</h1>
  <p className="text-gray-600  dark:text-white mb-2">Время: <span className="font-semibold dark:text-white text-gray-800">{time}</span></p>
  <p className="text-gray-600 dark:text-white">Текст: <span className="font-semibold dark:text-white  text-gray-800">{text}</span></p>
</div>
  );
}
